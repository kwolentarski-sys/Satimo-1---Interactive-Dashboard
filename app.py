...
test_desc_choice = st.sidebar.selectbox(
    "**Test Descriptions:**",
    ("🔵 None", "Pixel Phone S4 with Dipoles", "Yearly Dipoles", "Horns Monthly", "Phantom Wrist Dielectric Tracking", "LTE TRP", "LTE TIS")
)
...
if active_dataset_choice == "GPS CW L1 L5":
    ...
    if isinstance(raw_data, list) and len(raw_data) > 0:
        ...
        if measurements:
            ...
            # Clean up device name and catch 'nan' values
            display_device = str(device_name).replace('Reference: ', '')
